...
<head>
    ...
    <link href='<?php echo e(asset("content/ckeditor/ckeditor.css")); ?>' rel="stylesheet">
...
<body class="fix-header fix-sidebar">
                ...
                <div class="navbar-header">
                    <li class="nav-item"> 
                        ...
                        <div class="navbar-brand">
                            <img src="<?php echo e(asset('content/images/logo.png')); ?>" class="dark-logo" width="120px" height="40px" />
                    ...
                    <li class="nav-item m-l-10"> 
                        <a class="nav-link  hidden-sm-down text-muted  ">
                            <div class="navbar-brand">
                                ...
                                <img src="<?php echo e(asset('content/images/logo.png')); ?>" class="dark-logo" width="200px" height="50px" />   
                            </div>
                        </a>
                    </li>
                </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="email-compose.html" href="<?php echo e(route('menu_list')); ?>"><i class="fa fa-list-ul"></i></i>Menu</a>
                        </li>
                        <li> <a class="email-compose.html" href="<?php echo e(route('help_list')); ?>"><i class="fa fa-question-circle-o"></i></i>Help Desk</a>
                        </li>
                        <li> <a class="email-compose.html" href="<?php echo e(route('booking_list')); ?>"><i class="fa fa-handshake-o"></i></i>Booking</a>
                        </li>
    ...
    <!-- ck editor JS -->
    <script src="<?php echo e(asset('content/ckeditor/ckeditor.js')); ?>"></script>
